...
urlpatterns = [
    ...
    path('posts/trending/<int:page>/', views.trending, name='trending'),#nat
    path('posts/pals/', views.pals_posts, name='palsposts'),#nat
    path('posts/pals/<int:page>/', views.pals_posts, name='palsposts'),#nat
    ...
    path('posts/categories/<str:category_name>/<int:page>/',views.show_category, name='show_category'),#nat
